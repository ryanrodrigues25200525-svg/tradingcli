"""Regression coverage for the Alpaca-style schema v3 feature set."""
...
assert pt.healthcheck(conn)["schema_version"] == 3
conn.close()

# v2 -> v3 migration preserves accounts and fills new columns/tables.
